...
try{
	...
	if(conn != null){
		sql = "SELECT * FROM tb_hotel WHERE h_idx=4";
...
try{
	...
	conn = DriverManager.getConnection(url, uid, upw);
	if(conn != null){
		sql = "SELECT * FROM tb_grade WHERE g_idx=4";
		pstmt = conn.prepareStatement(sql);
		rs = pstmt.executeQuery();
...
try{
	...
	conn = DriverManager.getConnection(url, uid, upw);
	if(conn != null){
		sql = "SELECT * FROM tb_facility WHERE f_idx=4";
		pstmt = conn.prepareStatement(sql);
		rs = pstmt.executeQuery();
...
try{
	...
	conn = DriverManager.getConnection(url, uid, upw);
	if(conn != null){
		sql = "SELECT tb_review.r_grade, tb_review.r_title, tb_review.r_contents, tb_review.r_regdate, tb_customer.u_nickname FROM tb_review  LEFT OUTER JOIN tb_hotel ON r_idx = tb_hotel.h_idx LEFT OUTER JOIN tb_customer ON r_useridx = tb_customer.u_idx WHERE h_idx = 4;";
		pstmt = conn.prepareStatement(sql);
		rs = pstmt.executeQuery();
                            ...
                            <div>
                                <div class="checkIn">
                                    ...
                                    <div class="detail_date">
                                        ...
                                        <input type="text" name="datepicker2" id="datepicker1" class="date_picker">
                                        </div>
                                </div>
                                <div class="checkout">
                        ...
                        <section>
                            ...
                            <div class="content">
                                <div class="main_content">
                                    ...
                                    <div class="bxslider">
                                        <img class="main_content_7" src="../xm_images/<%=h_img%>1.jpg">
                                        <img class="main_content_8" src="../xm_images/<%=h_img%>1.jpg">
                                    </divcl>
