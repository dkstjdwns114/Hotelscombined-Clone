...
try{
	...
	if(conn != null){
		sql = "SELECT * FROM tb_hotel WHERE h_idx=1";
...
try{
	...
	conn = DriverManager.getConnection(url, uid, upw);
	if(conn != null){
		sql = "SELECT * FROM tb_grade WHERE g_idx=1";
		pstmt = conn.prepareStatement(sql);
		rs = pstmt.executeQuery();
...
try{
	...
	conn = DriverManager.getConnection(url, uid, upw);
	if(conn != null){
		sql = "SELECT * FROM tb_facility WHERE f_idx=1";
		pstmt = conn.prepareStatement(sql);
		rs = pstmt.executeQuery();
...
ArrayList<HashMap<String,String>> skybayList= detailDao.getSkybayList(); request.setAttribute("skybayList", skybayList);
%>
<c:set var="skybayList" value="${skybayList}"/>
                                ...
                                <div id="insert_location" class="insert_location">
                                    <div class="insert_box">
                                        ...
                                        <div class="location_box">
                                            <input type="text" id="location" value="강릉, 대한민국">
                                        </div>
                                    </div>
                        ...
                        <section>
                            ...
                            <div class="content">
                                <div class="main_content">
                                    ...
                                    <div class="bxslider">
                                        <img class="main_content_1" src="../xm_images/<%=h_img%>1.jpg">
                                        <img class="main_content_2" src="../xm_images/<%=h_img%>1.jpg">
                                    </divcl>
                            ...
                            <div class="products">
                                ...
                                <div class="product_main">
                                    ...
                                    <div class="hotel_details">
                                        <div class="hotelRoom_name"><a href="../jg_html/payIn_step1.jsp?param=1"> <%=priceDAO.getDesc()[1] %> </a>
                                        </div>
                                     ...
                                     <% if(userid == null){%>
														  ...
														  %>
                                                          <div class="hotel_price"><a  href="../jg_html/payIn_step1.jsp?param=12"><%=priceDAO.getOurPrice()[1] %>원</a></div>
                                                        <% } %>
                                    <div class="hotel_btn"><input onclick="location.href='../jg_html/payIn_step1.jsp?param=1'" type="button" value="호텔에서 결제" ></div>
                                </div>
                                ...
                                <c:if test="${status.index eq status.index}">
			                          <c:choose>
                                        ...
                                        <c:url var="url" value="https://www.agoda.com/ko-kr/search?cid=1617473&currency=KRW&checkin=${checkIn}&checkout=${checkOut}&NumberofAdults=${adults}&NumberofChildren=${children }&Rooms=${rooms}&mcid=3038&tag=4916267,pid1334087373&selectedproperty=4916267&city=19041&adults=${adults}&children=${children}&hc=KRW&los=1"/>
                                        </c:when>
                                        <c:when test="${map['logo'] eq 'hotelpass'}">
                                        <c:url var="url" value="http://hotelscombined.hotelpass.com/search/detail.asp?cmd=infoHotel&sNatCtyCode=KRKAG&hoteltype=2&hotelCode=KRKAG013&checkInDate=${checkIn}&checkOutDate=${checkOut}&RoomPassen=${adults},${children},_/&mAgentCD=A000002227&ConversionID=1334089381&NaverYN=N"/>
                                        </c:when>
                                ...
                                <div class="product_main">
                                    ...
                                    <div class="hotel_details ">
                                        <div class="hotelRoom_name"><a href="${url}"> ${map['desc1']} </a>
                                        </div>
                                        <span><i class="fas fa-check"></i>호텔에서 결제 
                                            • 무료 와이파이 </span>
                                    </div>
                                    <div class="hotel_price"><a href="${url}">${map['price1']}원</a></div>
