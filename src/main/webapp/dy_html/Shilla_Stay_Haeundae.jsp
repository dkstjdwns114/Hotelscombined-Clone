...
try{
	...
	if(conn != null){
		sql = "SELECT * FROM tb_hotel WHERE h_idx=8";
...
try{
	...
	conn = DriverManager.getConnection(url, uid, upw);
	if(conn != null){
		sql = "SELECT * FROM tb_grade WHERE g_idx=8";
		pstmt = conn.prepareStatement(sql);
		rs = pstmt.executeQuery();
...
try{
	...
	conn = DriverManager.getConnection(url, uid, upw);
	if(conn != null){
		sql = "SELECT * FROM tb_facility WHERE f_idx=8";
		pstmt = conn.prepareStatement(sql);
		rs = pstmt.executeQuery();
                        ...
                        <section>
                            ...
                            <div class="content">
                                <div class="main_content">
                                    ...
                                    <div class="bxslider">
                                        <img class="main_content_15" src="../xm_images/<%=h_img%>1.jpg">
                                        <img class="main_content_16" src="../xm_images/<%=h_img%>1.jpg">
                                    </divcl>
