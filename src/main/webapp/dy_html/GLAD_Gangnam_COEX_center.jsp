...
try{
	...
	if(conn != null){
		sql = "SELECT * FROM tb_hotel WHERE h_idx=6";
...
try{
	...
	conn = DriverManager.getConnection(url, uid, upw);
	if(conn != null){
		sql = "SELECT * FROM tb_grade WHERE g_idx=6";
		pstmt = conn.prepareStatement(sql);
		rs = pstmt.executeQuery();
...
try{
	...
	conn = DriverManager.getConnection(url, uid, upw);
	if(conn != null){
		sql = "SELECT * FROM tb_facility WHERE f_idx=6";
		pstmt = conn.prepareStatement(sql);
		rs = pstmt.executeQuery();
...
try{
	...
	conn = DriverManager.getConnection(url, uid, upw);
	if(conn != null){
		sql = "SELECT tb_review.r_grade, tb_review.r_title, tb_review.r_contents, tb_review.r_regdate, tb_customer.u_nickname FROM tb_review  LEFT OUTER JOIN tb_hotel ON r_idx = tb_hotel.h_idx LEFT OUTER JOIN tb_customer ON r_useridx = tb_customer.u_idx WHERE h_idx = 6;";
		pstmt = conn.prepareStatement(sql);
		rs = pstmt.executeQuery();
...
<head>
    ...
    <title><%=h_name %></title>
    <link rel="stylesheet" href="../dy_css/main.css?ver.0.1">
                        ...
                        <section>
                            ...
                            <div class="content">
                                <div class="main_content">
                                    ...
                                    <div class="bxslider">
                                        <img class="main_content_11" src="../xm_images/<%=h_img%>1.jpg">
                                        <img class="main_content_12" src="../xm_images/<%=h_img%>1.jpg">
                                    </divcl>
                    ...
                    <div class="review_info">
                        <div class="review_top">
                            <div class="review_hotel">
                                <h3><%=h_name%></h3>
                                <div><i class="fas fa-star starIcon fa-xs"></i><i class="fas fa-star starIcon fa-xs"></i><i class="fas fa-star starIcon fa-xs"></i></div>
                            </div>
