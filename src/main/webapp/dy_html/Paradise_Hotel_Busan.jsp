...
try{
	...
	if(conn != null){
		sql = "SELECT * FROM tb_hotel WHERE h_idx=9";
...
try{
	...
	conn = DriverManager.getConnection(url, uid, upw);
	if(conn != null){
		sql = "SELECT * FROM tb_grade WHERE g_idx=9";
		pstmt = conn.prepareStatement(sql);
		rs = pstmt.executeQuery();
...
try{
	...
	conn = DriverManager.getConnection(url, uid, upw);
	if(conn != null){
		sql = "SELECT * FROM tb_facility WHERE f_idx=9";
		pstmt = conn.prepareStatement(sql);
		rs = pstmt.executeQuery();
                        ...
                        <section>
                            ...
                            <div class="content">
                                <div class="main_content">
                                    ...
                                    <div class="bxslider">
                                        <img class="main_content_17" src="../xm_images/<%=h_img%>1.jpg">
                                        <img class="main_content_18" src="../xm_images/<%=h_img%>1.jpg">
                                    </divcl>
