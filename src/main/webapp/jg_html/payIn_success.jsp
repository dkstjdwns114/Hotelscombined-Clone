...
<head>
    ...
    <link rel="stylesheet" href="../payIn_css/payin_css.css?Ver0.1"/>	
    <title>결제</title>
</head>
<body>
    <!-- 웹 접근성을 위한 건너뛰기 링크 -->
    ...
    <div id = "wrap">
        ...
        <div id = "container">
            <div id = "content">
                ...
                <div class = "main_msg">
                    <p><b>예약신청이 정상적으로 완료되었습니다!</b></p>
                    <p>예약 완료시 금액과 가상 계좌번호는 SMS로 발송됩니다.</p>
                </div>
                <div class = "btn_box">
                    <input type="button" value = "마이페이지에서 확인하기" class="btn_typical" onclick="location.href='../asj_html/confirmOrder.jsp'">
